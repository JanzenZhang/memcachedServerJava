...
public class JavaApplicationClient {
    public static void main(String[] args) throws Exception {
        Charset charset = Charset.forName("ISO-8859-1");
        SocketChannel sc = SocketChannel.open(new InetSocketAddress("127.0.0.1", 10024));
        ...
        System.out.println("Got: " + c + " rawBytes: " + new String(b.array()));
        System.out.println("read bytes: " + a);
        }
}
